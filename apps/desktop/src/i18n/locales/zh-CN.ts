...
export default withEnglishFallback({
  ...
  grid: {
    ...
    copyDdl: "复制 DDL",
    copyIndexSql: "复制 SQL",
    copyForeignKeySql: "复制 SQL",
    copyConstraintSql: "复制 SQL",
    ...
    csvExportTitle: "CSV 导出选项",
    csvExportPrompt: "请选择 CSV 文件的写出方式：",
    csvExportQuoteModeAll: "所有字段加引号",
    csvExportQuoteModeAllDescription: "每个字段都用引号字符包裹（回读最安全）。",
    csvExportQuoteModeNecessary: "仅在需要时加引号",
    csvExportQuoteModeNecessaryDescription: "仅当字段包含分隔符、引号字符或换行时才加引号。",
    csvExportQuoteModeNever: "不加引号",
    csvExportQuoteModeNeverDescription: "所有字段原样写出；包含分隔符或换行的值不会被转义。",
    csvExportDelimiter: "分隔符",
    csvExportDelimiterComma: "逗号 ( , )",
    csvExportDelimiterSemicolon: "分号 ( ; )",
    csvExportDelimiterTab: "制表符",
    csvExportDelimiterPipe: "竖线 ( | )",
    csvExportDelimiterCustom: "自定义…",
    csvExportQuoteChar: "引号字符",
    csvExportQuoteCharDouble: '双引号 ( " )',
    csvExportQuoteCharSingle: "单引号 ( ' )",
    csvExportQuoteCharBacktick: "反引号 ( ` )",
    csvExportQuoteCharCustom: "自定义…",
    csvExportCustomDelimiterPlaceholder: "字符",
    csvExportCustomQuoteCharPlaceholder: "字符",
    csvExportIncludeHeader: "包含表头行",
    exportTxt: "导出 TXT",
    ...
    resultColumnCopied: "已复制 {column}：{value}",
    ...
    transposeSortColumns: "按列名 A–Z 排序",
    transposeSortColumnsOriginal: "恢复列原顺序",
  ...
  objectSearch: {
    placeholder: "筛选 {database} 中的表、视图、触发器、函数、存储过程…",
    placeholderNoDatabase: "筛选表、视图、触发器、函数、存储过程…",
    noResults: "未找到对象",
    results: "个对象",
    navigate: "导航",
    select: "选择",
    ...
    loading: "正在加载数据库对象…",
    loadError: "加载数据库对象失败",
    noActiveDatabase: "没有活动数据库 — 请先打开连接",
    trigger: "触发器",
    openSource: "源码",
    openData: "数据",
  },
  ...
  ai: {
    ...
    gitHubCopilotEndpointHint: "需要有有效 Copilot 订阅的 GitHub 账户令牌；此 API 没有 /v1 前缀。",
    contextWindow: "上下文窗口",
  ...
  foreignServer: {
    ...
    noMappings: "暂无用户映射",
    noTables: "暂无外部表",
    copySql: "复制 CREATE SERVER 语句",
    sqlCopied: "CREATE SERVER 语句已复制",
    ddlUnavailable: "无法生成 CREATE SERVER 语句：该服务器存在无法解析的选项。",
  },
  processList: {
  ...
  sqlParameters: {
    ...
    type: "类型",
    value: "参数值",
    valuePlaceholder: "输入参数值（留空发送 NULL）",
  ...
  settings: {
    ...
    snippetsImport: "导入",
    snippetsImportSuccess: "已导入 {count} 个代码片段，请点击“应用”保存。",
    snippetsImportSuccessRenamed: "已导入 {count} 个代码片段，其中 {renamed} 个触发键因重复已自动重命名，请点击“应用”保存。",
    snippetsImportInvalidJson: "文件不是有效的 JSON。",
    snippetsImportInvalidStructure: "文件必须是 VS Code 代码片段格式（名称到片段对象的映射）。",
    snippetsImportNoValidSnippets: "文件中没有可导入的代码片段。",
    snippetsImportFileTooLarge: "代码片段文件过大（上限 {limit}）。",
    snippetsImportReadFailed: "读取代码片段文件失败：{message}",
    snippetsExport: "导出",
    snippetsExportSuccess: "已导出 {count} 个代码片段。",
    snippetsExportWriteFailed: "写入代码片段文件失败：{message}",
    snippetsSelectAll: "全选代码片段",
    snippetsSelectSnippet: "选择片段",
    snippetsDeleteSelected: "删除所选（{count}）",
    snippetsFilterPlaceholder: "按名称、前缀或内容筛选…",
    snippetsFilterCount: "显示 {shown} / 共 {total} 条",
    snippetsFilterNoMatch: "没有符合筛选条件的代码片段。",
    snippetsFilterClear: "清空代码片段筛选",
    ...
    shortcutConvertSelectionToDelimited: "选中内容转换为带分隔符的列表",
    ...
    shortcutFocusDatabaseSelect: "打开数据库选择下拉框",
    ...
    shortcutCommitTransaction: "提交事务",
    shortcutCopyResultColumn1: "复制第一行结果的第 1 列",
    shortcutCopyResultColumn2: "复制第一行结果的第 2 列",
    shortcutCopyResultColumn3: "复制第一行结果的第 3 列",
    shortcutCopyResultColumn4: "复制第一行结果的第 4 列",
    shortcutCopyResultColumn5: "复制第一行结果的第 5 列",
