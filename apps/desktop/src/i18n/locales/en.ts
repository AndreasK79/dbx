...
export default {
  ...
  editor: {
    ...
    snippetQuickAdd: {
      prefixUnique: "Prefix must be unique.",
      saved: 'Snippet "{label}" added',
    },
    gotoLine: {
  ...
  grid: {
    ...
    copyJson: "Copy JSON",
    copyDdl: "Copy DDL",
    copyIndexSql: "Copy SQL",
    copyForeignKeySql: "Copy SQL",
    copyConstraintSql: "Copy SQL",
    ...
    csvExportTitle: "CSV Export Options",
    csvExportPrompt: "Choose how the CSV file is written:",
    csvExportQuoteModeAll: "Quote all fields",
    csvExportQuoteModeAllDescription: "Wrap every field in the quote character (safest for round-trips).",
    csvExportQuoteModeNecessary: "Quote only when needed",
    csvExportQuoteModeNecessaryDescription: "Quote a field only when it contains the delimiter, quote character, or a line break.",
    csvExportQuoteModeNever: "No quoting",
    csvExportQuoteModeNeverDescription: "Write every field raw; values containing delimiters or line breaks will not be escaped.",
    csvExportDelimiter: "Delimiter",
    csvExportDelimiterComma: "Comma ( , )",
    csvExportDelimiterSemicolon: "Semicolon ( ; )",
    csvExportDelimiterTab: "Tab",
    csvExportDelimiterPipe: "Pipe ( | )",
    csvExportDelimiterCustom: "Custom…",
    csvExportQuoteChar: "Quote character",
    csvExportQuoteCharDouble: 'Double quote ( " )',
    csvExportQuoteCharSingle: "Single quote ( ' )",
    csvExportQuoteCharBacktick: "Backtick ( ` )",
    csvExportQuoteCharCustom: "Custom…",
    csvExportCustomDelimiterPlaceholder: "Character",
    csvExportCustomQuoteCharPlaceholder: "Character",
    csvExportIncludeHeader: "Include header row",
    ...
    resultColumnCopied: "Copied {column}: {value}",
    ...
    transposeSortColumns: "Sort columns A–Z",
    transposeSortColumnsOriginal: "Restore column order",
  ...
  objectSearch: {
    placeholder: "Filter tables, views, triggers, functions, procedures in {database}…",
    placeholderNoDatabase: "Filter tables, views, triggers, functions, procedures…",
    ...
    loadError: "Failed to load database objects",
    noActiveDatabase: "No active database — open a connection first",
    trigger: "Trigger",
    openSource: "Source",
    openData: "View",
  },
  ...
  ai: {
    ...
    gitHubCopilotEndpointHint: "Needs a GitHub token from an account with an active Copilot subscription; this API has no /v1 prefix.",
  ...
  foreignServer: {
    ...
    schema: "Schema",
    table: "Table",
    noMappings: "No user mappings",
    noTables: "No foreign tables",
    copySql: "Copy CREATE SERVER SQL",
    sqlCopied: "CREATE SERVER SQL copied",
    ddlUnavailable: "CREATE SERVER SQL unavailable: the server has an unparseable option.",
  },
  processList: {
  ...
  sqlParameters: {
    ...
    type: "Type",
    value: "Value",
    valuePlaceholder: "Enter value (empty sends NULL)",
  ...
  settings: {
    ...
    snippetsImportSuccess: "Imported {count} snippets. Click Apply to save.",
    snippetsImportSuccessRenamed: "Imported {count} snippets and renamed {renamed} prefixes to avoid duplicates. Click Apply to save.",
    snippetsImportInvalidJson: "The file is not valid JSON.",
    snippetsImportInvalidStructure: "The file must be a VS Code snippets map of names to snippet objects.",
    snippetsImportNoValidSnippets: "No importable snippets found in the file.",
    snippetsImportFileTooLarge: "Snippets file is too large (limit {limit}).",
    snippetsImportReadFailed: "Failed to read the snippets file: {message}",
    snippetsExport: "Export",
    snippetsExportSuccess: "Exported {count} snippets.",
    snippetsExportWriteFailed: "Failed to write the snippets file: {message}",
    snippetsSelectAll: "Select all snippets",
    snippetsSelectSnippet: "Select snippet",
    snippetsDeleteSelected: "Delete Selected ({count})",
    snippetsFilterPlaceholder: "Filter by label, prefix, or body…",
    snippetsFilterCount: "Showing {shown} of {total}",
    snippetsFilterNoMatch: "No snippets match the filter.",
    snippetsFilterClear: "Clear snippet filter",
    ...
    shortcutFocusDatabaseSelect: "Open database selector dropdown",
    ...
    shortcutCommitTransaction: "Commit transaction",
    shortcutCopyResultColumn1: "Copy column 1 of first result row",
    shortcutCopyResultColumn2: "Copy column 2 of first result row",
    shortcutCopyResultColumn3: "Copy column 3 of first result row",
    shortcutCopyResultColumn4: "Copy column 4 of first result row",
    shortcutCopyResultColumn5: "Copy column 5 of first result row",
    ...
    shortcutConvertSelectionToDelimited: "Convert selection to delimited list",
