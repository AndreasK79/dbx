...
pub async fn ollama_selected_model_tool_support(config: &AiConfig) -> Result<Option<bool>, String> {
...
pub fn sensitive_values(config: &AiConfig) -> Vec<String> {
...
pub fn redact_secrets(value: &str, secrets: &[String]) -> String {
